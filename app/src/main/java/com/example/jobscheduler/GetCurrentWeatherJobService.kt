...
class GetCurrentWeatherJobService : JobService() {
    companion object {
        ...
        //isikan dengan nama kota kita
        internal const val CITY = "Bogor"

        //isikan dengan Api key dari openweathermap
        internal const val APP_ID = "0f0af44ac2a9f278664e745bbed80dcc"
    }

    override fun onStartJob(params: JobParameters): Boolean {
        Log.d(TAG, "onStartJob()")
        getCurrrentWeather(params)
    ...
    private fun getCurrrentWeather(job: JobParameters) {
